 ...
 *
 * 본문은 서식 에디터(Tiptap)가 만드는 것과 같은 HTML이다 — 관리자 화면에서 그대로 열린다.
...
const SAMPLE_ARTICLES: {
...
}[] = [
  {
    ...
    content: [
      "<p>해가 완전히 뜨기 전, 작업장의 불이 하나둘 켜집니다. 가장 먼저 하는 일은 오븐을 데우는 것. 온도가 올라오는 20분 동안 재료를 계량하고, 어제 저녁 준비해 둔 반죽을 냉장고에서 꺼냅니다.</p>",
      "<blockquote>서두르면 반죽이 먼저 알아요. 그래서 우리는 서두르지 않습니다.</blockquote>",
      "<p>오트밀과 통밀가루의 비율은 계절에 따라 조금씩 달라집니다. 습도가 높은 여름에는 물의 양을 살짝 줄이고, 반죽의 되기를 손끝으로 확인합니다. 계량기가 알려주지 않는 것을 손이 기억합니다.</p>",
      "<h2>같은 맛을 지킨다는 것</h2>",
      "<p>매일 같은 맛을 낸다는 건 생각보다 어려운 일입니다. 표준 레시피를 지키되, 그날의 재료 상태에 맞춰 미세하게 조정하는 균형 감각이 필요합니다. 이 감각은 하루아침에 생기지 않습니다.</p>",
      "<p>그래서 우리는 한 사람이 한 공정에 충분히 익숙해질 때까지 기다립니다. 익숙함이 정확함이 되고, 정확함이 신뢰가 됩니다.</p>",
    ].join("\n\n"),
  },
  {
    ...
    content: [
      "<p>모든 제품은 사람의 손을 거쳐 상자에 담깁니다. 리본의 매듭 하나에도 나름의 규칙이 있습니다.</p>",
      "<blockquote>받는 사람이 상자를 여는 순간을 상상하며 묶어요.</blockquote>",
      "<p>12년 동안 같은 자리에서 포장을 맡아온 손끝에는 흔들림이 없습니다.</p>",
    ].join("\n\n"),
  },
  {
    ...
    content: [
      "<p>대추는 산지에 따라 단맛과 향이 확연히 다릅니다. 우리는 매년 같은 농가와 계약합니다.</p>",
      "<p>가격이 오르는 해에도 산지를 바꾸지 않는 이유는 단순합니다. 맛이 달라지기 때문입니다.</p>",
    ].join("\n\n"),
  },
  {
    ...
    content: [
      "<p>오트 쿠키는 그대로 먹어도 맛있지만, 조금만 더하면 근사한 디저트가 됩니다.</p>",
      "<h2>1. 우유에 30초</h2>",
      "<p>차가운 우유에 살짝 적셔 먹으면 색다른 식감을 즐길 수 있습니다.</p>",
    ].join("\n\n"),
  },
  {
    ...
    content: [
      "<p>제품에 드러나지 않지만 가장 중요한 것은 위생입니다.</p>",
      "<blockquote>보이지 않아도, 먹는 사람은 결국 알게 됩니다.</blockquote>",
    ].join("\n\n"),
  },
  {
    ...
    content:
      "<p>누구에게나 첫 출근은 떨립니다. 이곳에서의 첫날은 조금 더 특별한 의미를 갖습니다.</p>",
  },
];
